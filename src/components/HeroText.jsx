...
const HeroText = () => {
  const words = ["UIUX Designer", "Frontend Developer", "Web Designer", "Web Developer", "React Developer",];
  const variants = {
  ...
  return (
    <div
      className="z-10 
  text-center md:text-left rounded-3xl bg-clip-text"
    >
